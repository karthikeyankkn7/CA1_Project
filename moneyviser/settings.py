"""
Django settings for moneyviser project.
...
SECRET_KEY = '_&z1z@pw5n^fam(+672_dr&&o8r16^g@+k3je+3jo(gq3)97q$'
...
WSGI_APPLICATION = 'moneyviser.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'USER': 'postgres',
        'ssl':'require',
        'PASSWORD':'@Karthikkn07',
        'HOST':'postgresmoneywiser.postgres.database.azure.com',
        'port':'5432',
    }
}
